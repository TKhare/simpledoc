...
- [x] Full-width text blocks by default (90% width, 5% margins)
- [ ] Settings panel for default text block width/margins (deferred)
- [x] Users can still manually resize individual blocks
