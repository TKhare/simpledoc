...
- Editing model is a blank 8.5 x 11 inch page with two object types:
    ...
    - text blocks
- Planning to use a CRDT-based document model (e.g., Yjs) so concurrent edits converge without manual conflict resolution. Ink strokes should be append-only CRDT elements; text blocks should use CRDT text.
